...
st.markdown("---")
st.warning("⚠️ This program is based on『內政部頒布 — 鋼骨鋼筋混凝土構造設計規範與解說（110年3月24日修正）』計算，for preliminary design reference only，Actual design must be reviewed by a licensed structural engineer。")
